...
class SettingsViewController: BaseViewController {
    ...
    @IBOutlet weak var rdoLabel: UILabel!
...
//        self.rdoLabel.layer.cornerRadius = 7
//        self.rdoLabel.layer.masksToBounds = true
		//if Defaults[.proOvertimeCalculator] || Defaults[.proRDOCalendar] {
			...
			if !Defaults[.proOvertimeCalculator] {
                ...
                overtimeLabel.isUserInteractionEnabled = true
                ...
                overtimeLabel.addGestureRecognizer(overtimeIconTapGesture)
			...
			if !Defaults[.proRDOCalendar] {
                ...
                rdoLabel.isUserInteractionEnabled = true
                ...
                rdoLabel.addGestureRecognizer(rdoIconTapGesture)
                rdoStackView.addGestureRecognizer(rdoTapGesture)
                
                rdoLabel.isHidden = false
