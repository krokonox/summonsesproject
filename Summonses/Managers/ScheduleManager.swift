...
class SheduleManager: NSObject {
    ...
    var department: DepartmentModel! = DepartmentModel(departmentType: DataBaseManager.shared.getShowOptions().department, squad: DataBaseManager.shared.getShowOptions().squad) {
        willSet {
